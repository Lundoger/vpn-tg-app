...
const MainPage = () => {
  const [keyV, setKeyV] = useState<string>('ss://hD12SN123JNSHBjDHb2V2gn12n323as');
  ...
  return (
    <section className={styles.section}>
      ...
      <div className={styles.keyContainer}>
        ...
        <div>
          <input onClick={handleCopy} name='key' readOnly type="text" value={keyV}></input>
      ...
      <div className={styles.info}>
          <p>Подписка: <span className={clsx(styles.subscription, styles.premium)}>Премиум</span></p>
          <p>Действует до: <span className={styles.date}>27/12/2025</span></p>
      </div>
